...
<div class="case-section" data-insurance-score="[X]" data-medical-score="[Y]">
  ...
  <div style="background:#fee2e2; border:2px solid #dc2626; padding:12px; border-radius:8px; margin:10px 0;">
    ...
    <div style="font-weight:bold; font-size:14px;">[اسم الدواء/الإجراء المرفوض]</div>
    <div style="margin:5px 0;">⚠️ [اسم الدواء] يحتاج توثيق المبرر الإكلينيكي. [سبب الرفض - مثل: الحرارة 36.1 لا تبرر الباراسيتامول الوريدي]</div>
    <div style="background:#fff; padding:8px; border-radius:4px; margin:5px 0;">
      <strong style="color:#059669;">📌 يُقبل مع:</strong> [اكتب الحالات التي يُقبل فيها هذا الدواء - مثال للمضاد الحيوي: "التهاب بكتيري محدد (حلق صديدي، رئوي، UTI)" - مثال للسوائل الوريدية: "جفاف شديد، عدم تحمل الفم، قيء مستمر"]
    </div>
  ...
  <div style="background:#fef3c7; border:2px solid #d97706; padding:12px; border-radius:8px; margin:10px 0;">
    ...
    <div style="font-weight:bold; font-size:14px;">[اسم الدواء/الإجراء]</div>
    <div style="margin:5px 0;">⚠️ [اسم الدواء] يحتاج توثيق المبرر الإكلينيكي.</div>
    <div style="background:#fff; padding:8px; border-radius:4px; margin:5px 0;">
      <strong style="color:#059669;">📌 يُقبل مع:</strong> [اكتب الحالات التي يُقبل فيها - أمثلة محددة للدواء]
    </div>
