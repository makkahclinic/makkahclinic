...
### 📌 جدول "يُقبل مع" الإلزامي (استخدم هذه العبارات بالضبط):

| نوع الدواء | 📌 يُقبل مع: (انسخ هذا النص بالضبط) |
|-----------|-----------------------------------|
| المضادات الحيوية (AZIMAC, AMOXICILLIN, AUGMENTIN, MEGAMOX, CEFIXIME, CIPROFLOXACIN) | التهاب بكتيري محدد (حلق صديدي، رئوي، UTI) |
| السوائل الوريدية (NORMAL SALINE, DEXTROSE, RINGER, I.V. INFUSION) | جفاف شديد، عدم تحمل الفم، قيء مستمر |
| الباراسيتامول الوريدي (PARACETAMOL IV, B.BRAUN) | عدم تحمل الفم، حالة طوارئ، حمى >39°C |
| مضادات الهيستامين (CLARA, ZYRTEC, LORATADINE) | أعراض تحسسية، تشخيص حساسية (مثل التهاب الأنف التحسسي) |
| مثبطات مضخة البروتون (OMEPRAZOLE, ESOPOLE, NEXIUM) | التهاب معدة موثق، GERD، استخدام NSAIDs طويل |
| مسكنات NSAIDs (IBUPROFEN, DICLOFENAC, RUMAFEN) | ألم متوسط-شديد موثق، التهاب مفاصل، نقرس |

⚠️ **قاعدة إلزامية**: لكل دواء مرفوض أو يحتاج توثيق، يجب نسخ عبارة "📌 يُقبل مع:" من الجدول أعلاه. ممنوع ترك هذا الحقل فارغاً!
`;
...
<div class="case-section" data-insurance-score="[X]" data-medical-score="[Y]">
  ...
  <div style="background:#fee2e2; border:2px solid #dc2626; padding:12px; border-radius:8px; margin:10px 0;">
    ...
    <div style="font-weight:bold; font-size:14px;">[اسم الدواء المرفوض]</div>
    <div style="margin:5px 0;">⚠️ [سبب الرفض المحدد - اربط بالعلامات الحيوية والتشخيص]</div>
    <div style="background:#fff; padding:8px; border-radius:4px; margin:5px 0;">
      <strong style="color:#059669;">📌 يُقبل مع:</strong> [انسخ من جدول "يُقبل مع" أعلاه حسب نوع الدواء - ممنوع تركه فارغاً!]
    </div>
  ...
  <div style="background:#fef3c7; border:2px solid #d97706; padding:12px; border-radius:8px; margin:10px 0;">
    ...
    <div style="font-weight:bold; font-size:14px;">[اسم الدواء]</div>
    <div style="margin:5px 0;">⚠️ يحتاج توثيق المبرر الإكلينيكي.</div>
    <div style="background:#fff; padding:8px; border-radius:4px; margin:5px 0;">
      <strong style="color:#059669;">📌 يُقبل مع:</strong> [انسخ من جدول "يُقبل مع" أعلاه - ممنوع تركه فارغاً!]
    </div>
