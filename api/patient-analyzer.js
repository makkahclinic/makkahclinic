...
❌ **ترفض إذا**: حرارة طبيعية (<37.5°C) + بدون توثيق ألم VAS
...
<div class="executive-summary" style="background:linear-gradient(135deg,#1e3a5f,#2d5a8b);padding:2rem;border-radius:16px;margin-top:2rem;color:#fff">
  ...
  <h3 style="color:#c9a962;margin:1.5rem 0 1rem">📈 مؤشرات الأداء KPI للطبيب</h3>
  <table style="width:100%;border-collapse:collapse;background:rgba(255,255,255,0.05);border-radius:8px;overflow:hidden;margin-bottom:1.5rem">
    <thead style="background:rgba(201,169,98,0.3)">
      <tr><th style="padding:10px;text-align:right">المؤشر</th><th style="padding:10px;text-align:center">القيمة</th><th style="padding:10px;text-align:center">الهدف</th><th style="padding:10px;text-align:center">الحالة</th></tr>
    </thead>
    <tbody>
      <tr style="border-bottom:1px solid rgba(255,255,255,0.1)">
        <td style="padding:10px">📉 نسبة رفض المضادات الحيوية</td>
        <td style="padding:10px;text-align:center">[X%]</td>
        <td style="padding:10px;text-align:center">&lt; 20%</td>
        <td style="padding:10px;text-align:center">[✅/❌]</td>
      </tr>
      <tr style="border-bottom:1px solid rgba(255,255,255,0.1)">
        <td style="padding:10px">📋 نسبة "يحتاج توثيق"</td>
        <td style="padding:10px;text-align:center">[X%]</td>
        <td style="padding:10px;text-align:center">&lt; 15%</td>
        <td style="padding:10px;text-align:center">[✅/❌]</td>
      </tr>
      <tr style="border-bottom:1px solid rgba(255,255,255,0.1)">
        <td style="padding:10px">💊 متوسط VAS عند مسكنات IV</td>
        <td style="padding:10px;text-align:center">[X/10]</td>
        <td style="padding:10px;text-align:center">≥ 7/10</td>
        <td style="padding:10px;text-align:center">[✅/❌]</td>
      </tr>
      <tr style="border-bottom:1px solid rgba(255,255,255,0.1)">
        <td style="padding:10px">💉 نسبة IV بدون مبرر</td>
        <td style="padding:10px;text-align:center">[X%]</td>
        <td style="padding:10px;text-align:center">&lt; 10%</td>
        <td style="padding:10px;text-align:center">[✅/❌]</td>
      </tr>
      <tr>
        <td style="padding:10px">🔄 نسبة التكرار</td>
        <td style="padding:10px;text-align:center">[X%]</td>
