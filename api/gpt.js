...
- **التواصل الاحترافي:** لا تستخدم أي عبارات آلية. إذا كانت قراءتك لكلمة ما غير واضحة، اذكر أفضل تخمين لك وأتبعه بعبارة "(قراءة غير واضحة، يتطلب توضيحاً من الطبيب)".
    ...
    return `
        ...
        **هيكل التقرير المطلوب (للاستخدام في المخرج النهائي):**
        ...
        <div class="section">
            ...
            <ul><!-- يتم ملء الأخطاء هنا كنقاط <li> --></ul>
            <h5>فرص تحسين الرعاية (الإجراءات الموصى بها):</h5>
            <ul><!-- يتم ملء الفرص هنا كنقاط <li> --></ul>
        </div>
