...
3. **التحليل السريري العميق والتوصيات الحاسمة:** هذا هو القسم الأهم. لكل خطأ وجدته من "قائمة التحقيق"، اكتب فقرة تحليلية مفصلة تتضمن:
...
4. **جدول الأدوية والإجراءات:** أنشئ جدولاً بالأعمدة التالية: "الدواء/الإجراء", "الجرعة المترجمة", "الغرض الطبي المرجح", "التفاعلات", "الوضع التأميني".
   - **الوضع التأميني:** استخدم الأيقونات التالية:
     - ✅ مقبول
     - ⚠️ يحتاج مراجعة/تبرير
     - ❌ خطير/مرفوض (استخدم هذه العلامة للأدوية التي تحتوي على خطأ حرج).
5. **فرص تحسين الرعاية (الإجراءات الناقصة):** أنشئ قائمة نقطية مفصلة بالفحوصات الناقصة، مع **ربط كل فحص بالدواء أو التشخيص الذي يبرره**. مثال:
    - "فحص وظائف الكلى (eGFR) ضروري قبل صرف دواء Metformin (Formet XR)."
    - "ملف دهون كامل (Lipid Profile) لتبرير دواء Rozavi."
    - "فحص السكر التراكمي (HbA1c) لمتابعة السكري."
    - "فحص مستضد البروستاتا النوعي (PSA) لتبرير دواء Duodart."
    - "تخطيط قلب (ECG) لمريض يعاني من ضغط وسكري ودهون."
6. **خطة العمل:** قائمة مرقمة وواضحة بأولويات التصحيح الفوري.
7. **المراجع العلمية:** اذكر بعض المصادر الموثوقة (مثل UpToDate, Medscape).
