...
// =============== ULTIMATE ENHANCEMENTS v10 (CLINICAL EXCELLENCE) ===============
// 1. Re-engineered the "Service Improvement" section into a mandatory, evidence-based "Monitoring & Lab Recommendations" section.
// 2. The model is now forced to link high-risk drugs to specific lab tests, cite the clinical reason, and provide an evidence source (e.g., ADA, KDIGO, FDA).
// 3. This is the final and most advanced version, designed to produce actionable clinical plans.
// ==============================================================================
...
// =============== SYSTEM PROMPTS (CLINICAL EXCELLENCE) ===============
...
- **قاعدة الاستنتاج الصيدلاني:** إذا كان اسم الدواء غير واضح (مثل Form XR)، حاول استنتاج المادة الفعالة الأكثر احتمالًا بناءً على السياق (مثل Metformin XR)، واذكر هذا الاستنتاج مع درجة الثقة.
- **قاعدة كبار السن (Geriatrics):** لأي مريض عمره > 65 عامًا، قم بالتحقق الإجباري من المخاطر التالية:
  1.  **خطر نقص السكر:** عند وجود أدوية Sulfonylurea (مثل Diamicron/Gliclazide)، يجب إصدار تحذير قوي وواضح من خطر نقص السكر.
  2.  **خطر السقوط:** عند وجود دوائين أو أكثر يخفضان الضغط، يجب إصدار تحذير قوي وواضح من خطر هبوط الضغط الانتصابي والسقوط.

[تحليل التداخلات الدوائية (DDI) - قاعدة إلزامية]
- في عمود "التداخلات"، لا تكتب أبدًا "مع أدوية أخرى". يجب أن تكون دقيقًا وتتبع المنهجية التالية:
...
- هذا القسم هو أهم جزء في التقرير. يجب أن تربط كل دواء عالي الخطورة بالتحليل اللازم له.
- استخدم الصيغة الإلزامية التالية لكل توصية:
  **اسم الفحص:** بسبب دواء [اسم الدواء]، ولرصد [التأثير الجانبي أو الوظيفة الحيوية]، حسب إرشادات [اسم المصدر].
- **أمثلة إلزامية للتطبيق:**
  - **eGFR/Creatinine:** بسبب دواء Metformin (أو Form XR المستنتج)، ولرصد وظائف الكلى، حسب إرشادات FDA/KDIGO.
  - **Potassium (K+):** بسبب دواء Co-Taburan (أو أي ARB/ACEi)، ولرصد خطر ارتفاع البوتاسيوم، حسب إرشادات ACC/AHA.
  - **HbA1c:** بسبب تشخيص السكري (من دواء Diamicron)، ولمتابعة التحكم في سكر الدم، حسب إرشادات ADA.
  - **ALT/AST:** بسبب دواء Rozavi (Rosuvastatin)، ولرصد وظائف الكبد، حسب توصيات الشركة المصنعة.
