// api/gpt.js
// ================================
// Edge Function — تحليل متقدم للحالات الطبية (CDI/UR) - Schema V6
...
// ======== استدعاء GPT‑4o (مع تحسينات ومعالجة أخطاء) =========
...
// ======== استدعاء Gemini (مع إصلاح حاسم لحد التوكنات) =========
...
  if(!GEMINI_API_KEY) return { ok:false, data:null, note:'GEMINI_API_KEY missing' };
  ...
      generationConfig: { 
          temperature: 0.1,
          // !!! إصلاح حاسم: زيادة maxOutputTokens من 1800 إلى 16384 !!!
...
function mergeReports(a={}, b={}, lang='ar'){
  ...
  // دالة مساعدة للوصول إلى المسارات العميقة بأمان (للتوافق مع المخطط الجديد والقديم إن وجد)
...
    const { lang='ar', modelChoice='both', specialty='', context='', images=[], text='', fileNames=[], apiVersion='v6.0.0' } = body||{};
    
