...
// ميزات: تعليمات طبية صارمة، كشف تداخلات موسّع، فرض ذكر "التخصص الطبي المناسب" بدلاً من عبارة عامة،
// حماية 413، retries/timeout، وتصحيح تلقائي للكلاسات والنِسَب٪، وربط الأعراض بالخدمات (CXR/LDCT).
...
[د] قواعد إضافية إلزامية للعمود "الجرعة الصحيحة المقترحة"
- عندما تحتاج إلى "مراجعة مع طبيب مختص"، اكتب **التخصص صراحة** + **إطار زمني مفضل**. أمثلة مُلزمة:
  • CKD أو Hyperkalemia أو ACEi/ARB + MRA ⇒ **طبيب كلى (Nephrology) خلال 48–72 ساعة**.
  • فشل قلبي/تداخلات قلبية أو تعدد مضادات التخثّر ⇒ **طبيب قلب (Cardiology) خلال أسبوع**.
  • ضبط سكري/تعديلات أدوية سكري أو CKD مع سكري ⇒ **طبيب غدد صماء (Endocrinology) خلال أسبوع**.
  ...
  • نقرس/Allopurinol وتعديلات جرعة ⇒ **طبيب روماتيزم (Rheumatology) خلال شهر**.
  • مشاكل INR/Warfarin أو نزف/خثار ⇒ **عيادة تخثّر أو أمراض دم (Hematology/Anticoagulation Clinic) خلال أسبوع**.
- أدرج التخصص المناسب **ضمن نفس خلية الجرعة المقترحة** (مثال: "إيقاف + مراجعة طبيب كلى خلال 48–72 ساعة").

[هـ] فرص تحسين الخدمة ورفع مستوى الدخل (وفق مصلحة المريض – مدعومة بالأدلة)
...
/** تصحيح ذاتي: إضافة % عند اللزوم + تطبيق الكلاسات على خلايا بدون class + تحويل http→https في الروابط */
