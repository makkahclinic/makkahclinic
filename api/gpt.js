...
- **قاعدة الأولوية المطلقة:** البيانات التي يقدمها المستخدم يدويًا (العمر، الجنس، إلخ) هي **مصدر الحقيقة المطلق**. إذا وجدت معلومة متضاربة في ملف مرفق (مثال: الجنس المحدد في الصورة)، يجب عليك الإشارة إلى هذا التضارب في قسم "تحليل الملفات المرفوعة"، ولكن يجب أن تبني تحليلك النهائي وقراراتك على بيانات المستخدم اليدوية.
...
export default async function handler(req, res) {
  // FIX: Corrected the typo here. It should be a single string.
