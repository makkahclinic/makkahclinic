...
const AuthGuard = {
    ...
    pagePermissions: {
        'cbahi': ['owner', 'admin', 'staff'],
        'rounds': ['owner', 'admin', 'staff'],
        'calibration': ['owner', 'admin', 'staff'],
        'complaints': ['owner', 'admin', 'staff'],
        'eoc': ['owner', 'admin', 'staff'],
        'incidents': ['owner', 'admin', 'staff'],
        'maintenance': ['owner', 'admin', 'staff'],
        'risk': ['owner', 'admin', 'staff'],
        'admin': ['owner', 'admin'],
