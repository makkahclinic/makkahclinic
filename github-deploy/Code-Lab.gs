...
const SHEET_DEFS = {
  ...
  AssetTasks:        ['TaskID','TaskName','Department','ExpectedFrequency','PhysicalAssetID','PhysicalDeviceName','RoomCode','RoomName'],
  ...
  CH03_FollowUps:    ['id','inspectionId','التاريخ','الموقع','المسؤول','عنوان السيناريو','مستوى الخطورة','السبب المختصر','الإجراء المطلوب','status','createdAt','scenarioId','ملاحظات','updatedAt','closedAt'],
  /** سجل تحديثات منفصل لكل متابعة (timeline — لا يُستبدل السجل السابق) */
  CH03_FollowUp_Updates: ['id','followUpId','التاريخ والوقت','الشخص','نوع التحديث','الملاحظة','الحالة بعد التحديث','createdAt'],
