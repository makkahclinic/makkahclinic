...
هذا المجلد يحتوي كود **مشروع Google Apps Script** المرتبط بـ:
...
3. أضف ملف **HTML** جديد باسم `ManagementUpload.html` (من القائمة: File → New → HTML file)، والصق فيه محتوى **ManagementUpload.html** من هذا المجلد.
...
بعد ذلك الرابط الحالي للـ exec سيعمل ويُظهر صفحة: **ادخل الاسم + الرقم السري** → ثم **رفع الموّهلات** و**عرض الموّهلات**.
