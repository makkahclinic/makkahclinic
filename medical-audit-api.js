...
const SINGLE_CASE_PROMPT = `أنت خبير في مراجعة الجودة الطبية ومطابقة البروتوكولات العلاجية.

## مهمتك:
تحليل الملفات الطبية المرفقة (وصفات، تحاليل، أشعة، تقارير) وتقييم مدى التزام الطبيب بالبروتوكولات الطبية.
