...
📷 الصور الطبية المرفقة - تعليمات التحليل:

🔴 يجب تحليل كل صورة بالتفصيل التالي:

1. **قراءة النص في الصورة حرفياً** - اقرأ كل ما هو مكتوب
2. **تحديد الأدوية المكتوبة** - اسم كل دواء بالضبط كما هو مكتوب
3. **تحديد الجرعات** - الجرعة والتكرار لكل دواء
4. **تقييم جودة الخط** - هل الخط واضح أم سيء؟ هل يمكن قراءته؟
5. **الأخطاء الإملائية** - أي أخطاء في كتابة أسماء الأدوية
6. **اختصارات غير واضحة** - أي اختصارات قد تسبب لبس
7. **معلومات ناقصة** - ما هو مفقود من الوصفة (تاريخ، توقيع، ختم، إلخ)
8. **تحذيرات السلامة** - أي شيء قد يسبب خطأ في صرف الدواء

قم بتحليل الصورة/الصور التالية:
` });
      ...
      userContent.push({ type: 'text', text: '\n⬆️ حلل هذه الصورة بدقة عالية واذكر كل التفاصيل المرئية.' });
    }
