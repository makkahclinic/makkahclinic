...
# 🏥 قواعد الفحوصات والتحاليل:
| الفحص | القاعدة |
|-------|---------|
| سكر عشوائي (Random Blood Sugar) | ⚠️ يحتاج تبرير إكلينيكي واضح (أعراض سكر حاد، مريض جديد، متابعة غير مستقر). إذا لم يوجد تبرير → "يجب توثيق السبب الإكلينيكي في الملف لتجنب رفض التأمين" |
| HbA1c | ✅ مقبول للسكري المعروف كل 3 أشهر، أو للتشخيص الأولي |
| CBC | ⚠️ يجب ربطه بالتشخيص (حمى، التهاب، فقر دم مشتبه) |
| تحاليل الكبد والكلى | ⚠️ تحتاج مبرر (متابعة مريض مزمن، أدوية تؤثر على الكبد/الكلى) |
| أشعة | ⚠️ يجب ذكر المؤشر السريري الواضح |

# 📋 صياغة التنبيهات (إلزامي):
❌ لا تكتب: "سكر عشوائي غير ضروري"
✅ اكتب: "⚠️ السكر العشوائي يحتاج تبرير إكلينيكي موثق (مثل: أعراض سكر حادة، مريض جديد مشتبه، متابعة مريض غير مستقر) - عدم التوثيق قد يؤدي لرفض التأمين"
...
- **صياغة التنبيهات**: لا تقل "غير ضروري" فقط! بل قل: "⚠️ يجب تبريره إكلينيكياً لتجنب رفض التأمين"

# 🏥 قواعد الفحوصات:
| الفحص | القاعدة |
|-------|---------|
| سكر عشوائي | ⚠️ يحتاج تبرير (أعراض حادة، تشخيص أولي، متابعة غير مستقر) - عدم التوثيق = رفض التأمين |
| CBC/تحاليل | ⚠️ يجب ربطها بالتشخيص السريري |

❌ لا تكتب: "تحليل غير ضروري"
✅ اكتب: "⚠️ [اسم التحليل] يحتاج تبرير إكلينيكي موثق في الملف لتجنب رفض التأمين"
